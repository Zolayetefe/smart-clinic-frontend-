...
const StaffManagement: React.FC = () => {
  ...
  const handleScheduleChange = (day: string, dayAvailabilities: AvailabilityForm[]) => {
    setFormData(prev => ({
      ...prev,
      availabilities: [
  ...
  const handleDeleteConfirm = async () => {
    ...
    try {
      setLoading(true);
      await api.delete(`/admin/staff/${deleteConfirmation.staffId}`);
      await fetchStaffs();
      setError(null);
    } catch (err) {
      if (axios.isAxiosError(err)) {
  ...
  return (
    <div className="container mx-auto px-4 py-6">
                      ...
                      <div className="max-w-xs">
                        <button
                          ...
                          onClick={() => setScheduleModal({
                            isOpen: true,
                            availabilities: staff.doctor?.availabilities || [],
      ...
      <DeleteConfirmation
        ...
        onCancel={() => setDeleteConfirmation({ isOpen: false, staffId: null, staffName: '' })}
      />
