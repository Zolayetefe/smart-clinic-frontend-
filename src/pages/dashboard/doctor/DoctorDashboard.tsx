      ...
      <div className="bg-gradient-to-r from-secondary to-secondary-dark rounded-lg p-6 shadow-md">
        <div className="md:flex md:items-center md:justify-between">
          <div>
            ...
            <p className="mt-1 text-white/80">You have {todayAppointments.length} appointments today</p>
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card className="bg-white">
          <CardBody className="flex flex-col items-center p-6">
            ...
            <p className="mt-1 text-3xl font-semibold text-secondary">{todayAppointments.length}</p>
            <Link 
              ...
              <div key={appointment.id} className="p-6 flex items-start">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center">
                    ...
                    <span className="ml-2 text-sm text-gray-500">{appointment.patientAge} years</span>
                  </div>
